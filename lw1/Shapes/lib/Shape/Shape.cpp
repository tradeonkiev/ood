...
namespace shapes {
    ...
    const std::string &Shape::GetId() const noexcept { return m_id; }

    gfx::Color Shape::GetColor() const noexcept { return m_color; }

    void Shape::SetColor(gfx::Color color) noexcept { m_color = color; }
    ...
    void Shape::SetBounds(const Rect &bounds) { m_strategy->SetBounds(bounds); }
